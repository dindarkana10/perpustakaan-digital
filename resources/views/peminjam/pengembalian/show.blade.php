...
<head>
  ...
  <title>Detail Pengembalian - Peminjam</title>
          ...
          <div class="card-body">
            ...
            @if($pengembalian->status_pengembalian != 'dikonfirmasi')
              <div class="alert alert-info d-flex align-items-center gap-2 mb-4">
                <iconify-icon icon="solar:info-circle-outline" width="24"></iconify-icon>
                <div>
                  <strong>Status: Menunggu Validasi Petugas.</strong> 
                  Silakan serahkan buku fisik ke petugas. Denda akhir akan dihitung setelah validasi.
                </div>
              </div>
            @endif
              ...
              <div class="col-md-4">
                <div class="p-3 border rounded h-100">
                  ...
                  <div class="row mb-2">
                    ...
                    <div class="col-6 fs-3 fw-bold">: {{ \Carbon\Carbon::parse($pengembalian->tanggal_kembali_aktual)->format('d/m/Y') }}</div>
                  </div>
                  <hr>
                  <div class="row">
              ...
              <div class="col-md-4">
                <div class="p-3 border rounded bg-light h-100">
                  ...
                  <div class="d-flex justify-content-between mb-2">
                    <span>Keterlambatan ({{ $pengembalian->keterlambatan_hari ?? 0 }} Hari)</span>
                  ...
                  <div class="d-flex justify-content-between fs-4 fw-bold">
                    ...
                    <span class="text-primary">Rp {{ number_format($pengembalian->total_denda ?? 0, 0, ',', '.') }}</span>
                  </div>
                </div>
              </div>
            </div>
                ...
                <table class="table table-bordered align-middle">
                  <thead class="table-light">
                    <tr>
                      ...
                      <th class="text-center">Kondisi (Dilaporkan)</th>
                  ...
                  <tbody>
                    @foreach($pengembalian->details as $detail)
                      <tr>
                        ...
                        <td class="text-end">Rp {{ number_format($detail->denda_kerusakan_buku ?? 0, 0, ',', '.') }}</td>
                      </tr>
                    @endforeach
                  </tbody>
                </table>
            ...
            @if($pengembalian->petugas)
              <div class="mt-4 text-end">
                <small class="text-muted">Divalidasi oleh: <strong>{{ $pengembalian->petugas->name }}</strong></small>
