            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h5 class="card-title fw-semibold mb-0">Edit Data Pengembalian</h5>
                    ...
                    <form action="{{ route('admin.pengembalian.update', $pengembalian->id) }}"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       class="form-control"
                                       value="{{ $pengembalian->peminjaman->user->name }}"
                                       readonly>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       class="form-control"
                                       value="{{ $pengembalian->peminjaman->keperluan }}"
                                       readonly>
                            </div>
                        </div>
                        ...
                        <div class="alert alert-warning d-flex align-items-center gap-2">
                            ...
                            Perubahan hanya bisa dilakukan selama status masih <strong>Menunggu Validasi</strong>.
                        </div>
